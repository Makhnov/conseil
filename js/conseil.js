...
function toClass(str) { // Remplace une chaine de caractère par une chaine équivalente utilisable en tant que classe css
...
function resizeConseil() { // Fonction qui permet de redimensionner un groupe de personnages en fonction de l'écran de l'utilisateur
	console.log('resize');
